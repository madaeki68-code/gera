-- Vena Pictures Mock Data for Supabase
...
('g1234567-89ab-cdef-0123-456789abcdef', 'Dedi Editor', 'Editor', 'dedi.editor@vena.pictures', '081777888999', 600000.00, '1122334455', 100000.00, 4.7, 'FREELANCER_DEDI'),
('h1234567-89ab-cdef-0123-456789abcdef', 'Rina Asisten', 'Assistant', 'rina.asisten@vena.pictures', '081666777888', 400000.00, '5566778899', 75000.00, 4.6, 'FREELANCER_RINA');
...
('i1234567-89ab-cdef-0123-456789abcdef', 'Dana Operasional', 'Dana untuk kebutuhan operasional sehari-hari', '💼', 'operational', 15000000.00, NULL, NULL),
('j1234567-89ab-cdef-0123-456789abcdef', 'Dana Darurat', 'Dana cadangan untuk situasi darurat', '🚨', 'emergency', 10000000.00, 20000000.00, NULL),
('k1234567-89ab-cdef-0123-456789abcdef', 'Investasi Peralatan', 'Dana untuk membeli peralatan baru', '📷', 'investment', 5000000.00, 30000000.00, NULL),
('l1234567-89ab-cdef-0123-456789abcdef', 'Bonus Tim', 'Dana untuk bonus kinerja tim', '🎉', 'bonus', 3000000.00, 10000000.00, NULL);

-- Sample Cards
INSERT INTO cards (id, card_holder_name, bank_name, card_type, last_four_digits, expiry_date, balance, color_gradient) VALUES
('m1234567-89ab-cdef-0123-456789abcdef', 'Andi Vena', 'Bank BCA', 'Debit', '1234', '2027-12-31', 25000000.00, 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'),
('n1234567-89ab-cdef-0123-456789abcdef', 'Vena Pictures', 'Bank Mandiri', 'Credit', '5678', '2026-08-31', 15000000.00, 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)'),
('o1234567-89ab-cdef-0123-456789abcdef', 'Andi Vena', 'Bank BNI', 'Debit', '9012', '2028-03-31', 8000000.00, 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)');
...
('p1234567-89ab-cdef-0123-456789abcdef', 'Pernikahan Sarah & Ahmad', 'Sarah & Ahmad', 'a1234567-89ab-cdef-0123-456789abcdef', 'Pernikahan', 'Paket Pernikahan Gold', '11234567-89ab-cdef-0123-456789abcdef', '2024-06-15', '2024-07-30', 'Ballroom Hotel Grand Indonesia', 60, 'Editing', 25000000.00, 12500000.00, 'Partial', '{"photographer": "Budi Cahaya", "videographer": "Sari Visual", "editor": "Dedi Editor"}'),

('q1234567-89ab-cdef-0123-456789abcdef', 'Event Launching PT Maju Bersama', 'PT Maju Bersama', 'b1234567-89ab-cdef-0123-456789abcdef', 'Korporat', 'Paket Acara Korporat', '21234567-89ab-cdef-0123-456789abcdef', '2024-04-20', '2024-05-04', 'Jakarta Convention Center', 100, 'Selesai', 8000000.00, 8000000.00, 'Paid', '{"photographer": "Budi Cahaya", "videographer": "Sari Visual"}'),

('r1234567-89ab-cdef-0123-456789abcdef', 'Lamaran Maya & Rudi', 'Maya & Rudi', 'c1234567-89ab-cdef-0123-456789abcdef', 'Lamaran', 'Paket Lamaran', '31234567-89ab-cdef-0123-456789abcdef', '2024-05-10', '2024-05-24', 'Taman Suropati', 30, 'Persiapan', 5000000.00, 2500000.00, 'Partial', '{"photographer": "Budi Cahaya"}'),

('s1234567-89ab-cdef-0123-456789abcdef', 'Foto Keluarga Santoso', 'Keluarga Santoso', 'd1234567-89ab-cdef-0123-456789abcdef', 'Keluarga', 'Sesi Foto Keluarga', '51234567-89ab-cdef-0123-456789abcdef', '2024-03-25', '2024-04-04', 'Studio Vena Pictures', 80, 'Cetak', 3500000.00, 3500000.00, 'Paid', '{"photographer": "Budi Cahaya"}');

-- Sample Transactions
INSERT INTO transactions (id, date, description, amount, type, project_id, category, method, card_id) VALUES
('t1234567-89ab-cdef-0123-456789abcdef', '2024-01-15', 'DP Pernikahan Sarah & Ahmad', 12500000.00, 'income', 'p1234567-89ab-cdef-0123-456789abcdef', 'DP Proyek', 'Transfer Bank', 'm1234567-89ab-cdef-0123-456789abcdef'),
('u1234567-89ab-cdef-0123-456789abcdef', '2024-02-20', 'Pelunasan Event PT Maju Bersama', 8000000.00, 'income', 'q1234567-89ab-cdef-0123-456789abcdef', 'Pelunasan Proyek', 'Transfer Bank', 'm1234567-89ab-cdef-0123-456789abcdef'),
('v1234567-89ab-cdef-0123-456789abcdef', '2024-01-20', 'Fee Fotografer - Budi Cahaya', 800000.00, 'expense', 'p1234567-89ab-cdef-0123-456789abcdef', 'Gaji Freelancer', 'Transfer Bank', 'm1234567-89ab-cdef-0123-456789abcdef'),
('w1234567-89ab-cdef-0123-456789abcdef', '2024-02-25', 'Transportasi Lokasi Shooting', 500000.00, 'expense', 'p1234567-89ab-cdef-0123-456789abcdef', 'Transportasi', 'Cash', NULL),
('x1234567-89ab-cdef-0123-456789abcdef', '2024-03-01', 'Sewa Lensa 85mm f/1.4', 1500000.00, 'expense', NULL, 'Peralatan', 'Debit Card', 'n1234567-89ab-cdef-0123-456789abcdef');

-- Sample Leads
INSERT INTO leads (id, name, contact_channel, location, status, date, notes, whatsapp) VALUES
('y1234567-89ab-cdef-0123-456789abcdef', 'Dinda & Fajar', 'Instagram', 'Bandung', 'Hot Lead', '2024-03-15', 'Tertarik paket prewedding, budget 6-7 juta', '081123456789'),
('z1234567-89ab-cdef-0123-456789abcdef', 'CV Sukses Mandiri', 'Referral', 'Surabaya', 'New', '2024-03-20', 'Butuh dokumentasi annual meeting', '081987654321'),
('aa234567-89ab-cdef-0123-456789abcdef', 'Keluarga Wijaya', 'WhatsApp', 'Jakarta', 'Follow Up', '2024-03-18', 'Ulang tahun ke-50, minta quotation foto keluarga', '081555777999'),
('bb234567-89ab-cdef-0123-456789abcdef', 'Rini & Alex', 'Website', 'Depok', 'Qualified', '2024-03-22', 'Pernikahan Desember 2024, budget 20-25 juta', '081444666888');

-- Sample Assets
INSERT INTO assets (id, name, category, purchase_date, purchase_price, serial_number, status, notes) VALUES
('cc234567-89ab-cdef-0123-456789abcdef', 'Canon EOS R5', 'Kamera', '2023-01-15', 65000000.00, 'CN001234567890', 'Active', 'Kamera utama untuk wedding'),
('dd234567-89ab-cdef-0123-456789abcdef', 'Sony A7 IV', 'Kamera', '2023-03-20', 45000000.00, 'SN987654321012', 'Active', 'Kamera backup dan video'),
('ee234567-89ab-cdef-0123-456789abcdef', 'Canon RF 24-70mm f/2.8L', 'Lensa', '2023-01-15', 25000000.00, 'RF001122334455', 'Active', 'Lensa utama portrait'),
('ff234567-89ab-cdef-0123-456789abcdef', 'MacBook Pro M2 Max', 'Komputer', '2023-06-10', 45000000.00, 'MBP2023001234', 'Active', 'Untuk editing foto dan video'),
('gg234567-89ab-cdef-0123-456789abcdef', 'DJI Mini 3 Pro', 'Drone', '2023-08-05', 12000000.00, 'DJI001234567', 'Active', 'Untuk aerial shot'),
('hh234567-89ab-cdef-0123-456789abcdef', 'Godox AD200 Pro', 'Lighting', '2023-02-28', 4500000.00, 'GX200001234', 'Active', 'Flash portable untuk outdoor');

-- Sample Profile (Main Vendor Profile)
INSERT INTO profiles (
    ...
    'ii234567-89ab-cdef-0123-456789abcdef',
...
-- Update Profiles admin_user_id (this should be done after creating the auth user)
-- UPDATE profiles SET admin_user_id = 'your-auth-user-id' WHERE email = 'admin@vena.pictures';